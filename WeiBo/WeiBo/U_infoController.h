...
@interface U_infoController : UIViewController<UINavigationBarDelegate,UINavigationControllerDelegate,UITextViewDelegate,NSURLConnectionDelegate,NSURLConnectionDataDelegate>
{
    UINavigationItem *info;
    UIImageView *im_bg;
    UITextView *nick;
...
@property(retain,nonatomic) IBOutlet UINavigationItem *info;
